...
export const SignupPage = () => {
  ...
  const formSubmit = async (e) => {
    ...
    try {
      ...
      setError(error?.data?.message || 'Error while signing up')
    }
  }
  ...
  return (
    <main className="min-h-screen grid place-items-center bordr-red-600">
      <div>
    <h1 className="text-6xl font-bold">Become a part of
    ...
    <span>Already have an account? <Link className="underline text-blue-500 hover:text-blue-700" to='/'> Log In</Link></span>
